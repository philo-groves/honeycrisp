export function usage(): string {
  return [
    ...
    "       honeycrisp session <create|begin-attempt|append-event|transition|import-capture|get|list> ... --json",
    ...
    "",
    "Protocol commands:",
    "  protocol describe               Show the versioned CLI and WebSocket client contract",
    "  session ...                     Persist and query Honeycrisp-owned session state",
    "  knowledge ...                   Query and maintain Honeycrisp-owned knowledge and artifacts",
    "  harness ...                     Resolve provider jobs, sources, plugins, and maintenance",
    "  complete --json                 Run a provider-neutral auxiliary completion",
    "",
    "Memory commands:",
